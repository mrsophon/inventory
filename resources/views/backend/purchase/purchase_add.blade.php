...
<div class="col-12">
        ...
        <div class="col-md-4">
            <div class="md-3">
                <label for="example-text-input" class="form-label">Date</label>
                 <input class="form-control example-date-input" value="{{ $date }}" name="date2" type="date"  id="date2">
            </div>
        </div>
    </div> -->
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="md-3">
                <label for="example-text-input" class="form-label">Date</label>
                 <!-- <input class="form-control example-date-input" value="{{ \Carbon\Carbon::now()->format('d/m/Y') }}" name="date" type="text"  id="date"> -->
                 <input class="form-control example-date-input" value="{{ $date }}" name="date" type="text"  id="date">
                 <!-- <p>{{ date('d/m/Y').' '.now("Asia/Tokyo")->toTimeString() }}</p> -->
