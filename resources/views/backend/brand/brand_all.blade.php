            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ route('brand.add') }}" class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;"><i class="fas fa-plus-circle"><span style="font-family:tahoma; font-weight: normal;"> Add Brand</span></i></a> <br> <br>

                        <h4 class="card-title">Brand All Data</h4>
