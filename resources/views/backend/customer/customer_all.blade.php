...
@section('admin')
 ...
 <div class="page-content">
    ...
    <a href="{{ route('customer.add') }}" class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;"><i class="fas fa-plus-circle"><span style="font-family:tahoma; font-weight: normal;"> Add Customer </span></i></a> <br>  <br>               
