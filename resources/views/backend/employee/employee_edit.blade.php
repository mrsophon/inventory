        ...
        <div class="card-body">
            ...
            <form method="post" action="{{ route('employee.update') }}" id="myForm" enctype="multipart/form-data" >
                    ...
                    <div class="col-sm-10">
                        <select name="emptype_id" class="form-select" aria-label="Default select example">
                            ...
                            @foreach($emptype as $empt)
                                <option value="{{ $empt->id }}" {{ $empt->id == $employee->emptype_id ? 'selected' : '' }} >{{ $empt->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="form-group col-sm-10">
                        <input name="mobile_no"  value="{{ $employee->mobile_no }}" class="form-control" type="text"    >
                    </div>
                </div>
                <!-- end row -->
                ...
                <div class="row mb-3">
                    ...
                    <div class="form-group col-sm-10">
                        <input name="address" value="{{ $employee->address }}" class="form-control" type="text"  >
                    </div>
                </div>
                <!-- end row -->
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <img id="showImage" class="rounded avatar-lg" src="{{ asset($employee->employee_image) }}" alt="Card image cap">
                    </div>
                </div>
                <!-- end row -->
