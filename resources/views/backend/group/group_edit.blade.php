            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Edit Group</h4><br><br>

                        <form method="post" action="{{ route('group.update') }}" id="myForm">
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-10">
                                    <input name="name" value="{{ $group->name }}" class="form-control" type="text">
                                </div>
                            </div>
                            <!-- end row -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select name="hidden" class="form-select" aria-label="Default select example">
                                        <option value="0" {{ $group->hidden == "0" ? 'selected' : '' }}>No</option>
                                        <option value="1" {{ $group->hidden == "1" ? 'selected' : '' }}>Yes</option>
