...
use App\Http\Controllers\Pos\GroupController;
use App\Http\Controllers\Pos\TypeController;
...
Route::middleware('auth')->group(function() {
    ...
    Route::controller(GroupController::class)->group(function () {
        ...
        Route::post('/group/store', 'GroupStore')->name('group.store');
    ...
    Route::controller(TypeController::class)->group(function () {
        ...
        Route::get('/type/add', 'TypeAdd')->name('type.add');
